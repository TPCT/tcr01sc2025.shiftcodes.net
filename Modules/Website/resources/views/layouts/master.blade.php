...
<head>
    ...
    <link rel="preload" href="{{asset('/website/css/font-awesome.css')}}" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <link rel="preload" href="{{asset('/website/css/owl.carousel.min.css')}}" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <link rel="preload" href="{{asset('/website/css/owl.theme.default.min.css')}}" as="style" onload="this.onload=null;this.rel='stylesheet'">
    ...
    <link rel="preload" href="{{asset('/website/css/media.css')}}" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link rel="stylesheet" href="{{asset('/website/css/media.css')}}"></noscript>
    <!-- <link rel="stylesheet" href="{{asset('/css/bootstrap-rtl.min.css')}}"> -->

    <noscript><link rel="stylesheet" href="{{asset('/website/css/font-awesome.css')}}" ></noscript>
    <noscript><link rel="stylesheet" href="{{asset('/website/css/owl.carousel.min.css')}}" ></noscript>
    <noscript><link rel="stylesheet" href="{{asset('/website/css/owl.theme.default.min.css')}}" ></noscript>
    @section('css')
    @show
...
<body>
                ...
                <div class="col-lg-3 col-7">
                    <a href="{{url('/listyourcar')}}">
                        <div class="header__list_your_car">
                            <img width="30" height="30" alt="listcar" class="car" src="{{asset('/website/images/header_car.png')}}" />
                            <p>{{__('lang.List your cars in TAJEER platform')}}</p>
                            <img alt="upload" class="icon" width="26" height="25" src="{{asset('/website/images/icons/upload.png')}}" />
                        </div>
                    </a>
                </div>
                <div class="col-lg-7">
                            ...
                            <ul class="header__actions_menu">
                                @foreach(app('country')->getAllCountries() as $country)
                                    <li>
                                        ...
                                        <li>
                                            <a href="{{ LaravelLocalization::getLocalizedURL(null, route('website.switch-city', ['slug' => 0])) }}">{{__('lang.All')}}
                                        ...
                                        @foreach($country->cities as $city)
                                            <li>
                                                <a href="{{ LaravelLocalization::getLocalizedURL(null, route('website.switch-city', ['slug' => $city->slug])) }}">{{$city->title}}
                        ...
                        <li class="header__actions_list_item">
                            ...
                            <ul class="header__actions_menu">
                                @foreach(app('currencies')->getAllCurrencies() as $currency)
                                    <li>
                                        <a href="{{ LaravelLocalization::localizeUrl("/currency/{$currency->id}/switch") }}">{{$currency->code}}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </li>
    ...
    @php
        ...
        $supportedLanguages = \Mcamara\LaravelLocalization\Facades\LaravelLocalization::getSupportedLocales(); // Get supported languages from LaravelLocalization
            ...
            <li>
                <a href="{{ $newUrl }}" class="text-decoration-none">
                    <div class="px-1" style="margin-top:-10px; border-radius: 15%; cursor: pointer; background-color: #fff">
                        ...
                        }}" style="width:20px;height:16px" class="rounded-1 m-0" alt="{{ __('lang.lang_' . $langCode) }}">
                ...
                <ul class="header__actions mobile__header_actions">
                            ...
                            <ul class="header__actions_menu">
                                @foreach(app('country')->getAllCountries() as $country)
                                    <li>
                                        ...
                                        <ul class="cities_menu">
                                        <li>
                                            <a href="{{ LaravelLocalization::getURLFromRouteNameTranslated( App::currentLocale(), 'website.switch-city', ['slug' => 0]) }}">{{__('lang.All')}}
                                                @if(app('country')->getCountry()->id == $country->id && !app('country')->getCity())
                                                <i class="fa fa-check"></i>
                                                @endif
                                            </a>
                        ...
                        <li class="header__actions_list_item">
                            ...
                            <ul class="header__actions_menu">
                                @foreach(app('currencies')->getAllCurrencies() as $currency)
                                    <li>
                                        <a href="{{ LaravelLocalization::localizeUrl("/currency/{$currency->id}/cars") }}">{{$currency->code}}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </li>
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="{{ LaravelLocalization::localizeUrl("/p/{$item->id}/{$item->slug}") }}">{{$item->name}}</a>
                            @endforeach
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="{{ LaravelLocalization::localizeUrl("/d/cars") }}">{{__('lang.Rent a car with driver')}}</a>
                    </li>


                    <li class="nav-item active">
                        <a class="nav-link" href="{{ LaravelLocalization::localizeUrl("/yacht") }}">{{__('lang.Rent yacht')}}</a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="{{ LaravelLocalization::localizeUrl("/contact") }}">{{__('lang.Contact Us')}}</a>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="{{app('settings')->get('contact_twitter')}}">
                                <img width="36" height="36" alt="twitter" src="{{asset('/website/images/icons/twitter.png')}}" />
                            </a>
                        </li>
                        <li>
                            <a href="{{app('settings')->get('contact_instagram')}}">
                                <img width="36" height="36" alt="instagrm" src="{{asset('/website/images/icons/instagram.png')}}" />
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="{{app('settings')->get('app_apple_store')}}">
                                <img alt="app" width="115" height="41"  class="apps-image" src="{{asset('/website/images/icons/appstore.webp')}}" />
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9">
                    <ul>
                        <li>
                            <a data-toggle="tooltip" data-placement="left" title="{{__('lang.FAQ')}}" href="{{ LaravelLocalization::localizeUrl("/faq") }}">{{__('lang.FAQ')}}</a>
                        </li>
                        <li>
                            <a data-toggle="tooltip" data-placement="left" title="{{__('lang.Blog')}}" href="{{ LaravelLocalization::localizeUrl("/blog") }}">{{__('lang.Blog')}}</a>
                        </li>
                        <li>
                            <a data-toggle="tooltip" data-placement="left" title="{{__('lang.Contact Us')}}" href="{{ LaravelLocalization::localizeUrl("/contact") }}">{{__('lang.Contact Us')}}</a>
                        </li>
                        @foreach(app('settings')->getFooterPages() as $key => $item)

                            <li  >
                                <a data-toggle="tooltip" data-placement="left" title="{{$item->name}}" href="{{ LaravelLocalization::localizeUrl("/p/{$item->id}/{$item->slug}") }}">{{$item->name}}</a>
                            </li>
                        ...
                        @foreach(\App\Models\Type::get() as $t)
                            ...
                            <li>
                                <a data-toggle="tooltip" data-placement="left" title="{{__('lang.Rent')}} {{$t->title}}" href="{{ LaravelLocalization::localizeUrl("/t/{$t->sync_id}/{$t->slug()}") }}">{{__('lang.Rent')}} {{$t->title}}</a>
                            </li>
                        @endforeach
                    ...
                    <div class="footer-apps">
                        <p>
                            ...
                            <a style="margin-top:15px;display:block" href="{{app('settings')->get('app_google_play')}}">
                                ...
                                <img alt="app" width="125" height="37"  src="{{asset('/website/images/icons/googleplay.webp')}}" />
                            </a>
                             <a href="{{app('settings')->get('app_apple_store')}}">

                                <img loading="lazy" width="125" height="37" style="margin-top:10px" alt="app"  src="{{asset('/website/images/icons/appstore2.webp')}}" />
