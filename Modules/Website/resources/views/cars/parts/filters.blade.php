        ...
        <div class="products-page__filter_body">
            ...
            <div class="price-range-container">
                ...
                <div class="slider-wrapper">
                    ...
                    <input type="range" id="maxRange" min="0" max="{{app('currencies')->convert($max_price)}}" value="{{app('currencies')->convert(request('max_price', $max_price))}}" step="1000" name="max_price">
                </div>
